...
// Zig used `ArrayIdentityContext.U64`; the key is already a package-name hash.
pub type Map = ArrayHashMap<PackageNameHash, PostinstallOptimizer, bun_collections::U64>;
