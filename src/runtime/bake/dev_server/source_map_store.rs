...
use bun_collections::{
    ArrayHashMap, LinearFifo, array_hash_map::ArrayHashContext, linear_fifo::StaticBuffer,
};
...
impl ArrayHashContext<Key> for KeyContext {
    #[inline]
    ...
    #[inline]
    fn eql(&self, a: &Key, b: &Key, _: usize) -> bool {
        a == b
    }
}
...
pub struct SourceMapStore {
    pub entries: ArrayHashMap<Key, Entry, KeyContext>,
